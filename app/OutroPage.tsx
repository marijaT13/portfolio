...
export default function OutroPage(){
    return(
        <div className="flex flex-col justify-center items-center h-screen mt-">
             <h1 className="text-9xl text-center font-sans">Let's work together!</h1>
             <div className="flex flex-col sm:flex-row gap-4 justify-center items-center m-30">
             ...
             <Card className="ml-20 inline-flex text-center bg-transparent border-none shadow-xl p-2">
                <CardContent className="p-0">
